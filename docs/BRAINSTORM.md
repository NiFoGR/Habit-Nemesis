...
- One habit in full: overview, score, history, every streak, and a calendar of
  weeks by weekday that shows a habit has quietly become a weekend-only habit.
...
was that **two of them were the same bug wearing different clothes**: a rule
...
- **A full list of best streaks** on a habit screen. It is a lot of screen, but
