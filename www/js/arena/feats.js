...
export const FEATS = [
  ...
  { id: 'returned', section: 'The grid', icon: 'repeat', days: 30, name: 'Came back',
    ...
    test: () => cameBack(14, 7) },
  { id: 'protocolDiscipline', section: 'The grid', icon: 'flash', days: 30, name: 'The discipline block',
    blurb: 'Thirty days of discipline, four rows, four in five kept.',
    test: () => habits.completedProtocol('discipline') },
  { id: 'protocolSplit', section: 'The grid', icon: 'flash', days: 56, name: 'The split',
    blurb: 'Eight weeks of push, pull and legs, four in five kept.',
    test: () => habits.completedProtocol('split') },
  { id: 'protocolSleep', section: 'The grid', icon: 'flash', days: 28, name: 'The sleep protocol',
    blurb: 'Four weeks of the same night, four in five kept.',
    test: () => habits.completedProtocol('sleep') },
  ...
  { id: 'cleared', section: 'The Arena', icon: 'shield', days: 60, name: 'Cleared',
    blurb: 'On Notice, then a month at the bar. The notice is off.',
    test: () => monthList().some((m) => m.cleared) },
  { id: 'noticeComeback', section: 'The Arena', icon: 'crown', days: 60, name: 'Comeback',
    blurb: 'On Notice, then promoted. The best turnaround the ladder has.',
